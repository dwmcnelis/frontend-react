...
export const UserAuthRedirect = UserAuthWrapper({
  authSelector: state => state.auth.user,
  failureRedirectPath: '/login',
  wrapperDisplayName: 'AuthenticatedRedirect'
})

export const UserAuthVisible = UserAuthWrapper({
  authSelector: state => state.auth.user,
  FailureComponent: null,
  wrapperDisplayName: 'AuthenticatedVisible'
})
